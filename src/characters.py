...
class Characters(SpriteAnimation):
    ...
    def load_character(self, character):
        ...
        if character == 'vegeta':
            photo3x4_img = "resources/images/player/vegeta/vegeta-2.png"
            self.photo3x4 = pygame.image.load(photo3x4_img).convert_alpha()
            self.photo3x4Fliped = pygame.transform.flip(self.photo3x4, 1, 0)
            win_img = "resources/images/player/vegeta/vegetaWin.jpeg"
            self.Win = pygame.image.load(win_img).convert_alpha()
            sprite = "resources/images/player/vegeta/vegeta-ss4-2.png"
            self.load_sprites(sprite)
        ...
        if character == 'trunks':
            photo3x4_img = "resources/images/player/trunks/trunks3x4.png"
            self.photo3x4 = pygame.image.load(photo3x4_img).convert_alpha()
            self.photo3x4Fliped = pygame.transform.flip(self.photo3x4, 1, 0)
            if self.player_id == 2:
                win_img = "resources/images/player/trunks/win2.jpg"
                self.Win = pygame.image.load().convert_alpha(win_img)
                self.Win = pygame.transform.flip(self.Win, 1, 0)
            else:
                win_img = "resources/images/player/trunks/win2.jpg"
                self.Win = pygame.image.load(win_img).convert_alpha()
            self.load_sprites("resources/images/player/trunks/trunks.png")
            ...
            self.build_animation("teleport", hold=True, speed=5)
        if character == 'frieza':
            photo3x4_img = "resources/images/player/frieza/frieza3x4.png"
            self.photo3x4 = pygame.image.load(photo3x4_img).convert_alpha()
            self.photo3x4Fliped = pygame.transform.flip(self.photo3x4, 1, 0)
            win_img = "resources/images/player/frieza/win.png"
            self.Win = pygame.image.load(win_img).convert_alpha()
            self.load_sprites("resources/images/player/frieza/frieza-3.png")
            ...
            self.build_animation("dispute", hold=True, speed=5)
        if character == 'gohan':
            photo3x4_img = "resources/images/player/gohan/gohan3x4.png"
            self.photo3x4 = pygame.image.load(photo3x4_img).convert_alpha()
            self.photo3x4Fliped = pygame.transform.flip(self.photo3x4, 1, 0)
            win_img = "resources/images/player/gohan/win.png"
            self.Win = pygame.image.load(win_img).convert_alpha()
            self.load_sprites("resources/images/player/gohan/gohan.png")
    ...
    def load_power(self, power):
        ...
        Load power images
        """
        sprite = "resources/images/player/goku/ss4/power-1.png"
