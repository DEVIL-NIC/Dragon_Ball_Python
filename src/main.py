...
class Main():
    def __init__(self, window=0, resolution=(1280, 1024)):
        scenery1_image = "resources/images/scenarios/Wasteland-2.jpg"
        scenery2_image = "resources/images/scenarios/namek-3d-2.jpg"
        scenery3_image = "resources/images/scenarios/trunks-future-2.png"
        scenery4_image = "resources/images/scenarios/arena-2-2.gif"
        ...
        self.scenery = [scenery1, scenery2,
                        scenery3, scenery4]
        menu_image = "resources/images/load/background/goku-vs-vegeta-2.jpg"
        goku100x100 = "resources/images/player/goku/ss4/goku100x100.png"
        vegeta100x100 = "resources/images/player/vegeta/vegeta100x100.png"
        trunks100x100 = "resources/images/player/trunks/trunks100x100.png"
        frieza100x100 = "resources/images/player/frieza/frieza100x100.png"
        gohan100x100 = "resources/images/player/gohan/gohan100x100.png"
    ...
    def show_splashscreen(self):
        ...
        splash = pygame.image.load(
            "resources/images/load/splash/logo.png").convert()
        for i in range(25):
            splash.set_alpha(i)
    ...
    def game_credits(self):
        ...
        my_font = pygame.font.SysFont("monospace", 45)
        bold_font = pygame.font.SysFont("monospace", 55, bold=True)
        game_developer = bold_font.render("Game Developer", 1, RED)
        mark = my_font.render("Mark (GOD)", 1, RED)
        supporters = bold_font.render("Special Thanks", 1, RED)
        bru = my_font.render("Estevao", 1, RED)
        self.screen.blit(game_developer, (200, 150))
        self.screen.blit(mark, (200, 210))
